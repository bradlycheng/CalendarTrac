...
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, "https://rss.itunes.apple.com/api/v1/us/apple-music/coming-soon/all/100/explicit.json"); //https://rss.itunes.apple.com/api/v1/us/apple-music/new-releases/all/100/explicit.json
...
echo "COMING SOON ON APPLE MUSIC";
